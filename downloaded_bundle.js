...
` +
    ...
    var ke = Object.prototype.hasOwnProperty,
      ...
      Pe = t.unstable_now,
      A = t.unstable_getCurrentPriorityLevel,
    ...
    function Ue(e) {
      if (
        ...
        j && typeof j.setStrictMode == `function`)
      )
        try {
    ...
    var Cn = {
      ...
      An = h({}, Tn, {
        ...
        movementX: function (e) {
          return `movementX` in e
            ...
            : (e !== kn &&
                (kn && e.type === `mousemove`
                  ? ((Dn = e.screenX - kn.screenX),
                    (On = e.screenY - kn.screenY))
                  : (On = Dn = 0),
                (kn = e)),
              Dn);
        },
      ...
      Pn = Sn(
        h({}, Cn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      ),
      Fn = Sn(
        h({}, Cn, {
    ...
    function cr(e, t, n, r) {
      (on ? (sn ? sn.push(r) : (sn = [r])) : (on = r),
        (t = Ed(t, `onChange`)),
        0 < t.length &&
          ((n = new wn(`onChange`, `change`, null, n, r)),
    ...
    function xi(e, t) {
      if (typeof e == `object` && e) {
        var n = bi.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: k(t) }), bi.set(e, t), t)
          : n;
      }
    ...
    function ka(e, t, n) {
      switch (
        ((n = e[n]),
        n === void 0 ? e.push(t) : n !== t && (t.then(F, F), (t = n)),
        t.status)
      ) {
        case `fulfilled`:
          return t.value;
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((co(t), a))
          ...
          if (
            ((r = K),
            r !== null && ((s = M(r, n)), s !== 0 && s !== o.retryLane))
          )
    ...
    function Cc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (
            ((s = K),
            s !== null && ((r = M(s, n)), r !== 0 && r !== l.retryLane))
          )
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Pc(t);
            ...
            if (((e = _e.current), Ui(t))) {
              ...
              ((e = Bd(e).createTextNode(r)), (e[N] = t), (t.stateNode = e));
          }
          return (U(t), null);
        case 31:
    ...
    function Bu() {
      if (iu === 4 || iu === 3) {
        ...
        if (
          ...
          ct(n),
          (t = t.stateNode),
          j && typeof j.onCommitFiberRoot == `function`)
        )
          try {
    ...
    function Uu() {
      ...
      try {
        ...
        if (
          ...
          (G = c),
          id(0, !1),
          j && typeof j.onPostCommitFiberRoot == `function`)
        )
          try {
...
`,
  ...
  ie = T(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  ae = T(`circle-check`, [
  ...
  Te = Array.from({ length: 18 }, (e, t) => {
    let n = 18 - t;
    return {
      id: `L'${n}`,
      name: n >= 16 ? `Dong lanh` : `Thuc pham kho`,
      cat: n >= 16 ? `Frozen` : `Food`,
    };
  }),
  Ee = {
    unchecked: {
    ...
    ? e
        .map((e) => {
          let t = String(
              ...
              .replace(/\s/g, ``)
              .trim(),
            n = String(e?.barcode || e?.productId || e?.ean || t)
              .replace(/\s/g, ``)
              .trim();
          return {
            locId: Number(e?.locId),
            sku: t,
            barcode: n || t,
            productId: n || t,
            name: String(e?.name || ``)
        ...
        .filter(
          (e) => Number.isFinite(e.locId) && e.locId > 0 && (e.sku || e.name),
        )
        .sort((e, t) => t.locId - e.locId)
    : [];
}
function Oe(e) {
  return String(e || ``)
...
function k(e, t) {
  return { id: Date.now(), type: e, message: t };
}
function ke(e) {
  return Ee[e] || Ee.unchecked;
}
function Ae() {
  return [Ee.unchecked, Ee.in_stock, Ee.low_stock, Ee.out_of_stock];
}
function je(e) {
  return {
    stockStatus: ke(e?.stockStatus).id,
    stockCheckedAt: e?.stockCheckedAt || null,
  };
}
function Me(e, t) {
  ...
  return (
    (t || []).forEach((e) => {
      let t = je(e),
        i = String(e?.sku || ``).trim(),
        a = `${Number(e?.locId) || 0}|${Oe(e?.name || ``)}`;
      (i && n.set(i, t), a !== `0|` && r.set(a, t));
    }),
    e.map((e) => {
      let t = String(e?.sku || ``).trim(),
        i = `${Number(e?.locId) || 0}|${Oe(e?.name || ``)}`,
        a = (t && n.get(t)) || r.get(i);
      return a
        ? { ...e, ...a }
        : { ...e, stockStatus: Ee.unchecked.id, stockCheckedAt: null };
    })
  );
}
function Ne(e) {
...
var Pe = o((e) => {
  ...
  ze = Ae(),
  Be = `picker-assistant-auth-token`,
  Ve = `Loss Details`,
  He = `Summary`;
function j(e) {
  let t = Number(e);
...
function Ue(e) {
  let t = String(e?.sku || ``)
      .replace(/\s/g, ``)
      .trim(),
    n = String(e?.barcode || e?.productId || e?.ean || ``)
      .replace(/\s/g, ``)
      .trim();
  return Oe(`${e?.name || ``} ${e?.locId || ``} ${t} ${n}`);
}
function We(e) {
  return String(e || ``)
    .replace(/\s/g, ``)
...
function Ge(e = new Date()) {
  let t = e instanceof Date ? e : new Date(e),
    n = Number.isNaN(t.getTime()) ? new Date() : t;
  return `Kỳ kiểm loss ${new Intl.DateTimeFormat(`vi-VN`, { day: `2-digit`, month: `2-digit`, year: `numeric` }).format(n)}`;
}
function Ke(e) {
  return String(e || ``)
    .trim()
...
function Ze(e) {
  let t = Je(e?.systemStock),
    n = Je(e?.actualStock),
    r = Je(e?.quantity);
  return {
    systemStock: t,
    actualStock: n,
    lossQuantity: Math.max(
      0,
      Number.isFinite(Number(e?.lossQuantity))
        ? Math.trunc(Number(e.lossQuantity))
        : Ye(t, n) || r,
    ),
  };
}
function Qe({ text: e, highlight: t }) {
  if (!e) return null;
  let n = String(e);
  if (!t || t.trim().length < 2) return (0, A.jsx)(`span`, { children: n });
  try {
    let e = t.replace(/[.*+?^${}()|[\]\\]/g, `\\$&`);
    return (0, A.jsx)(`span`, {
      children: n
        ...
        .map((e, n) =>
          e.toLowerCase() === t.toLowerCase()
            ? (0, A.jsx)(
                `mark`,
                { className: `search-highlight`, children: e },
                `${e}-${n}`,
              )
            : (0, A.jsx)(C.Fragment, { children: e }, `${e}-${n}`),
        ),
    });
  } catch {
    return (0, A.jsx)(`span`, { children: n });
  }
}
function $e({
  visual: e,
  ...
  if (!e?.src)
    return (0, A.jsx)(`section`, {
      className: `planogram-card planogram-card-empty`,
      children: (0, A.jsx)(`div`, {
        className: `planogram-empty-icon`,
        children: (0, A.jsx)(D, { size: 28 }),
      }),
    });
  let i = new Set((t || []).map(j)),
    a = !e.version || e.version < 2,
    o = (Array.isArray(e.markers) ? e.markers : [])
      .map((e, t) => {
        let n = Number(e?.y),
          r = Number(e?.x);
        ...
        return {
          ...
          normalizedY: o,
          x: r,
          isHighlighted: i.has(s),
          emphasis: e.emphasis || 1,
          key: `${s}-${r}-${n}-${t}`,
        };
      })
      .filter(Boolean),
    s = o.map((e) => e.normalizedY),
    c = s.length > 0 ? Math.min(...s) : 0,
    l = s.length > 0 ? Math.max(...s) : 1,
    u = s.length > 0 ? Math.min(1, Math.max(0.72, l + 0.14)) : 1,
    d = u > 0.97 ? 1 : u,
    f = s.length > 0 ? Math.max(0, Math.min(0.62, c - 0.22)) : 0,
    p = Number(e.cropTop),
    m = Number.isFinite(p) ? Math.max(0, Math.min(p, 0.8)) : f,
    h = m >= d - 0.26 ? Math.max(0, d - 0.26) : m,
    g = Math.max(0.26, d - h),
    _ = (0, C.useRef)(null),
    [v, y] = (0, C.useState)({
      active: !1,
  ...
  function w(e) {
    ...
    !n.width ||
      ...
      y({
        active: !0,
        x: Math.min(1, Math.max(0, (e.clientX - n.left) / n.width)),
        y: Math.min(1, Math.max(0, (e.clientY - n.top) / n.height)),
        width: n.width,
        height: n.height,
      });
  }
  ...
  let te = v.height > 0 ? v.height / g : 0,
    T = v.x * v.width,
    ne = (h + v.y * g) * te,
    re = v.width * S,
    ie = te * S,
    ...
    oe = 178 / 2 - ne * S,
    se =
      r && v.active && v.width > 0 && te > 0
        ? o
            .filter((e) => n || e.isHighlighted)
            .map((e) => {
              let t = e.x * v.width,
                n = e.normalizedY * te;
              return {
        ...
        : [],
    ce = { left: `${v.x * 100}%`, top: `${v.y * 100}%` },
    le = {
      backgroundImage: `url(${e.src})`,
      backgroundSize: `${re}px ${ie}px`,
      backgroundPosition: `${ae}px ${oe}px`,
    },
    E = {
      "--pog-ratio": `${b} / ${x * g}`,
      "--pog-crop-top": String(h),
      "--pog-crop-bottom": String(d),
      "--pog-crop-span": String(g),
    };
  return (0, A.jsx)(`section`, {
    className: `planogram-card`,
    children: (0, A.jsxs)(`div`, {
      className: `planogram-stage ${g < 0.99 ? `is-bottom-cropped` : ``}`,
      style: E,
      ref: _,
      onPointerEnter: w,
      onPointerMove: w,
      ...
      children: [
        ...
        r && v.active
          ? (0, A.jsxs)(`div`, {
              className: `planogram-magnifier`,
              style: ce,
              children: [
                (0, A.jsx)(`div`, {
                  className: `planogram-magnifier-image`,
                  style: le,
                }),
                (0, A.jsx)(`div`, {
                  className: `planogram-magnifier-overlay`,
                  children: se.map((e) =>
                    (0, A.jsx)(
                      `div`,
                      {
                        className: `planogram-marker planogram-marker-lens ${e.isHighlighted ? `is-highlighted` : `is-passive`}`,
                        style: {
                          left: `${e.lensX}px`,
                          top: `${e.lensY}px`,
                          "--marker-scale": e.emphasis,
                        },
                        title: `Lọc ${e.markerLọcKey}`,
                      },
                      `lens-${e.key}`,
                    ),
                  ),
          ...
          : null,
        (0, A.jsx)(`div`, {
          className: `planogram-overlay`,
          children: o.map((e) => {
            let t = e.isHighlighted;
            return n || t
              ? (0, A.jsx)(
                  `div`,
                  {
                    className: `planogram-marker ${t ? `is-highlighted` : `is-passive`}`,
                    style: {
                      left: `${e.x * 100}%`,
                      top: `${e.normalizedY * 100}%`,
                      "--marker-scale": e.emphasis,
                    },
                    title: `Lọc ${e.markerLọcKey}`,
                    children: (0, A.jsx)(`span`, { children: e.marker.locId }),
                  },
                  e.key,
                )
              : null;
...
function et() {
  let [e, t] = (0, C.useState)({}),
    ...
    [i, a] = (0, C.useState)([]),
    [o, s] = (0, C.useState)(!0),
    [c, l] = (0, C.useState)(() => window.innerWidth <= 760),
    [u, d] = (0, C.useState)(() => window.innerWidth > 1180),
    [f, p] = (0, C.useState)(`pog`),
    [m, h] = (0, C.useState)(`main`),
    [g, _] = (0, C.useState)(`L12-A`),
    [v, y] = (0, C.useState)(``),
    [b, x] = (0, C.useState)(null),
    [S, w] = (0, C.useState)(``),
    [ee, te] = (0, C.useState)(``),
    [T, D] = (0, C.useState)(() => Ge()),
    [Ce, Ee] = (0, C.useState)([]),
    [Ae, je] = (0, C.useState)(!1),
    [Pe, Fe] = (0, C.useState)(!1),
    [Ie, Le] = (0, C.useState)(!1),
    [et, tt] = (0, C.useState)(!1),
    [nt, rt] = (0, C.useState)(``),
    [it, at] = (0, C.useState)(`unknown`),
    [ot, M] = (0, C.useState)(null),
    [st, ct] = (0, C.useState)(() => window.localStorage.getItem(Be) || ``),
    [lt, ut] = (0, C.useState)(null),
    [dt, N] = (0, C.useState)(!1),
    [ft, pt] = (0, C.useState)(!1),
    [mt, ht] = (0, C.useState)(``),
    [gt, _t] = (0, C.useState)(``),
    [vt, yt] = (0, C.useState)(``),
    [bt, xt] = (0, C.useState)(!1),
    [St, Ct] = (0, C.useState)(1),
    [P, wt] = (0, C.useState)(`L17`),
    [Tt, Et] = (0, C.useState)(`A`),
    [Dt, Ot] = (0, C.useState)(!1),
    [kt, At] = (0, C.useState)([]),
    [jt, Mt] = (0, C.useState)(null),
    [Nt, Pt] = (0, C.useState)(null),
    Ft = (0, C.useRef)(null),
    It = (0, C.useRef)(null),
    Lt = (0, C.useRef)(null),
    Rt = (0, C.useRef)(null),
    ...
    Ht = (0, C.useRef)(null),
    [Ut, Wt] = (0, C.useState)(() => {
      let e = Math.round(window.innerWidth * 0.38);
      return Math.min(Math.max(e, 420), 780);
    }),
    [Gt, Kt] = (0, C.useState)(!1),
    qt = (0, C.useMemo)(() => [...we, ...Te], []),
    Jt = (0, C.useMemo)(() => Oe(v), [v]),
    Yt = (0, C.useMemo)(() => Oe(S), [S]),
    Xt = lt?.displayName || lt?.username || `Tài khoản`,
    Zt = !lt,
    Qt = f === `pog` ? v : S,
    $t =
      f === `pog`
  ...
  function en(e) {
    let t = Math.max(360, Math.min(920, window.innerWidth - 280));
    return Math.min(Math.max(e, 360), t);
  }
  async function tn() {
    ...
    let t = Ht.current;
    if (
      ((!t || t.state === `closed`) && ((t = new e()), (Ht.current = t)),
      t.state === `suspended`)
    )
      try {
        await t.resume();
    ...
    if (!(!e || e.state !== `running`))
      try {
        let t = e.createOscillator(),
          ...
          r = e.currentTime;
        ((t.type = `sine`),
          t.frequency.setValueAtTime(1046, r),
          t.frequency.exponentialRampToValueAtTime(1318, r + 0.08),
          n.gain.setValueAtTime(1e-4, r),
          n.gain.exponentialRampToValueAtTime(0.06, r + 0.02),
          n.gain.exponentialRampToValueAtTime(1e-4, r + 0.16),
          t.connect(n),
  ...
  let F = (0, C.useMemo)(() => {
      ...
      return i
        ? {
            ...i,
            side: r,
            data: { products: e[g] || [], visual: n[g] || null },
          }
        : null;
    }, [e, n, qt, g]),
    rn = (0, C.useMemo)(
      () =>
        Jt
          ? Object.entries(e).flatMap(([e, t]) =>
              (t || [])
                .filter((e) => Ue(e).includes(Jt))
                .map((t) => ({ lineKey: e, product: t })),
            )
          : [],
      [e, Jt],
    ),
    an = (0, C.useMemo)(
      () =>
        !F || !Jt ? [] : F.data.products.filter((e) => Ue(e).includes(Jt)),
      [Jt, F],
    ),
    on = (0, C.useMemo)(() => {
      if (!F) return [];
      if (!Jt) return F.data.products;
      let e = [],
        t = [];
      return (
        F.data.products.forEach((n) => {
          Ue(n).includes(Jt) ? e.push(n) : t.push(n);
        }),
        [...e, ...t]
      );
    }, [Jt, F]),
    ...
    cn = (0, C.useMemo)(() => {
      let e = {
        total: F?.data.products.length || 0,
        checked: 0,
        unchecked: 0,
        in_stock: 0,
        low_stock: 0,
      ...
      return (
        (F?.data.products || []).forEach((t) => {
          let n = ke(t?.stockStatus).id;
          e[n] += 1;
        }),
        (e.checked = e.in_stock + e.low_stock + e.out_of_stock),
        e
      );
    }, [F]),
    ln = (0, C.useMemo)(
      () =>
        Object.values(e).filter((e) => Array.isArray(e) && e.length > 0).length,
      [e],
    ),
    un = (0, C.useMemo)(
      () =>
    ...
    dn = (0, C.useMemo)(() => {
      ...
      return (
        Object.entries(e).forEach(([e, n]) => {
          (n || []).forEach((n) => {
            let r = We(n?.sku),
              i = We(n?.barcode || n?.productId || n?.ean || n?.sku),
              a = We(n?.productId || n?.barcode || n?.ean || n?.sku),
              o = {
                lineKey: e,
                locId: n?.locId,
                name: String(n?.name || ``),
                sku: String(n?.sku || i || a || ``),
                barcode: String(
                  n?.barcode || n?.productId || n?.ean || n?.sku || ``,
                ),
                productId: String(
                  n?.productId || n?.barcode || n?.ean || n?.sku || ``,
                ),
                stockStatus: ke(n?.stockStatus).id,
              };
            [r, i, a].forEach((e) => {
              e && !t.has(e) && t.set(e, o);
            });
      ...
      () =>
        Yt
          ? Ce.filter((e) => {
              let t = Ze(e);
              return Oe(
                `${e?.barcode || ``} ${e?.productId || ``} ${e?.sku || ``} ${e?.name || ``} ${e?.lineKey || ``} ${e?.locId || ``} ${t.systemStock} ${t.actualStock} ${t.lossQuantity}`,
              ).includes(Yt);
            })
          : Ce,
      [Ce, Yt],
    ...
    pn = (0, C.useMemo)(
      () =>
        Yt
          ? i.filter((e) =>
              Oe(
                `${e?.periodName || ``} ${e?.createdByName || ``} ${e?.itemCount || ``} ${e?.totalLossQuantity || e?.totalQuantity || ``} ${e?.totalSystemStock || ``} ${e?.totalActualStock || ``}`,
              ).includes(Yt)
                ? !0
                : (e?.items || []).some((e) => {
                    let t = Ze(e);
    ...
    mn = (0, C.useMemo)(
      () => ({
        ...
        totalLoss: Ce.reduce((e, t) => e + Ze(t).lossQuantity, 0),
        totalSystemStock: Ce.reduce((e, t) => e + Ze(t).systemStock, 0),
        totalActualStock: Ce.reduce((e, t) => e + Ze(t).actualStock, 0),
      }),
      [Ce],
    );
  ((0, C.useEffect)(() => {
    if (!ot) return;
    let e = window.setTimeout(() => M(null), 5e3);
    return () => window.clearTimeout(e);
  }, [ot]),
    (0, C.useEffect)(() => {
      function e() {
        (l(window.innerWidth <= 760),
          d(window.innerWidth > 1180),
          Wt((e) => en(e)));
      }
      return (
        e(),
      ...
      async function t() {
        ...
        try {
          if (navigator?.permissions?.query) {
            let t = await navigator.permissions.query({ name: `camera` });
            if (e) return;
            (at(t.state),
              (t.onchange = () => {
                at(t.state);
    ...
    (0, C.useEffect)(() => {
      ...
      return (
        jn().catch((t) => {
          e || (rt(t?.message || `Khong mo duoc camera quet barcode.`), tt(!1));
        }),
        () => {
          ((e = !0), On());
        }
    ...
    (0, C.useEffect)(() => {
      ...
      async function t() {
        ...
        try {
          ...
          if (t.status === 401) throw Error(`Phiên đăng nhập đã hết hạn.`);
          if (!t.ok) throw Error(`Không thể xác thực tài khoản (${t.status}).`);
          let n = await t.json();
          if (!e) return;
          ut(n?.user || null);
        } catch (t) {
          ...
          (window.localStorage.removeItem(Be),
            ct(``),
            ut(null),
            M(k(`error`, t.message || `Phiên đăng nhập đã hết hạn.`)));
        }
      }
      return (
        t(),
    ...
    (0, C.useEffect)(() => {
      let e = !0;
      s(!0);
      async function n(n = !1) {
        try {
          let i = st ? { Authorization: `Bearer ${st}` } : void 0,
            o = await fetch(`/api/state`, { cache: `no-store`, headers: i });
          if (o.status === 401) {
            if (!e) return;
            st &&
              (window.localStorage.removeItem(Be),
          ...
          if (!o.ok)
            throw Error(`Khong tai duoc du lieu chia se (${o.status}).`);
          let s = await o.json();
          if (!e) return;
          (t(
            s?.aisleProducts && typeof s.aisleProducts == `object`
              ? s.aisleProducts
              : {},
          ),
            r(
              s?.aisleVisuals && typeof s.aisleVisuals == `object`
                ? s.aisleVisuals
                : {},
            ),
            a(Array.isArray(s?.lossAudits) ? s.lossAudits : []));
        } catch (t) {
          if (!e || n) return;
          M(
            k(
              `error`,
              t.message || `Khong ket noi duoc kho du lieu dung chung.`,
            ),
          );
        } finally {
          e && !n && s(!1);
      ...
      n(!1);
      let i = window.setInterval(() => n(!0), 8e3);
      return () => {
        ((e = !1), window.clearInterval(i));
      };
    }, [st]),
    (0, C.useEffect)(() => {
      an.length !== 0 &&
        x((e) => {
          if (!e) return an[0].locId;
          let t = j(e);
          return an.some((e) => j(e.locId) === t) ? e : an[0].locId;
        });
    }, [an]),
    (0, C.useEffect)(() => {
      if (!bt || !g) return;
  ...
  function gn(e) {
    ...
    let t = e.clientX,
      n = Ut;
    (Kt(!0), document.body.classList.add(`layout-resizing`));
    function r(e) {
      Wt(en(n + (t - e.clientX)));
    }
    function i() {
    ...
    (window.addEventListener(`pointermove`, r),
      window.addEventListener(`pointerup`, i, { once: !0 }));
  }
  function _n() {
    if (Zt) {
      (N(!0),
        M(k(`error`, `Vui lòng đăng nhập để sử dụng tính năng cập nhật POG.`)));
      return;
    }
    if (g) {
      let [e, t] = g.split(`-`);
  ...
  async function vn(e) {
    ...
    let t = mt.trim(),
      n = gt;
    if (!t || !n) {
      M(k(`error`, `Vui lòng nhập đầy đủ tài khoản và mật khẩu.`));
      return;
    }
    pt(!0);
    try {
      ...
      if (!e.ok || !r?.token)
        throw Error(r?.error || `Đăng nhập thất bại (${e.status}).`);
      (window.localStorage.setItem(Be, r.token),
        ct(r.token),
        ut(r.user || null),
        _t(``),
        N(!1),
        M(
          k(
            `success`,
            `Xin chao ${r?.user?.displayName || r?.user?.username || t}.`,
          ),
        ));
    } catch (e) {
      M(k(`error`, e.message || `Đăng nhập thất bại.`));
    } finally {
      pt(!1);
    }
  }
  async function yn() {
    ...
    (window.localStorage.removeItem(Be),
      ...
      N(!1),
      xt(!1),
      M(k(`success`, `Da dang xuat thanh cong.`)));
  }
  async function bn(e, n, o = i) {
    if (!st || !lt) throw Error(`Vui lòng đăng nhập để chỉnh sửa dữ liệu.`);
    ...
    if (!s.ok) throw Error(`Khong luu duoc du lieu dung chung (${s.status}).`);
    let c = await s.json();
    return (
      t(c?.aisleProducts || {}),
      r(c?.aisleVisuals || {}),
      a(Array.isArray(c?.lossAudits) ? c.lossAudits : []),
      c
    );
  }
  function xn() {
    (Ct(1), Ot(!1), At([]), Mt(null), Pt(null));
  }
  function Sn() {
    (xt(!1), xn());
  }
  function Cn(e) {
    ...
    if (t) {
      if (t.type !== `application/pdf`) {
        (Pt(null), M(k(`error`, `Chi chap nhan tep PDF planogram.`)));
        return;
      }
      (Pt(t), At([]), Mt(null), Ct(1));
    }
  }
  async function wn() {
    if (!Nt) {
      M(k(`error`, `Vui long tai len tep PDF truoc khi phan tich.`));
      return;
    }
    (Ot(!0), Ct(2));
    try {
      let { extractPlanogramFromPdf: e } = await Re(async () => {
          let { extractPlanogramFromPdf: e } = await import(
            `./pdfParser-CltnQ_2O.js`
          );
          return { extractPlanogramFromPdf: e };
        }, []),
        t = await e(Nt, { lineId: P, side: Tt });
      (At(t.products || []), Mt(t.visual || null), Ct(3));
    } catch (e) {
      (Ct(1), M(k(`error`, e.message || `Khong the phan tich tep PDF.`)));
    } finally {
      Ot(!1);
    }
  }
  async function Tn() {
    let t = `${P}-${Tt}`,
      r = Me(
        De(kt).map((e) => ({ ...e, verified: !0 })),
        e[t] || [],
      );
    if (r.length === 0) {
      M(k(`error`, `Khong co du lieu hop le de cap nhat.`));
      return;
    }
    let a = { ...e, [t]: r },
      o = jt?.src ? { ...n, [t]: jt } : n;
    try {
      (await bn(a, o, i),
        ...
        M(
          k(
            `success`,
            `Dong bo hoan tat: da nap ${r.length} san pham vao ${t}${jt?.src ? ` kem hinh line.` : `.`}`,
          ),
        ));
    } catch (e) {
      M(k(`error`, e.message || `Khong the luu du lieu dung chung.`));
    }
  }
  async function En(r, a) {
    if (Zt) {
      (N(!0), M(k(`error`, `Vui lòng đăng nhập để cập nhật tồn kho.`)));
      return;
    }
    if (!g) return;
    let o = e[g] || [],
        ...
        [g]: o.map((e, t) =>
          t === s
            ? {
                ...
                stockStatus: c,
                stockCheckedAt:
                  c === `unchecked` ? null : new Date().toISOString(),
              }
            : e,
        ),
      };
    ...
    try {
      ...
      (t(u), M(k(`error`, e.message || `Không lưu được thông tin tồn kho.`)));
    } finally {
      yt((e) => (e === l ? `` : e));
    }
  }
  ...
  function On() {
    ((zt.current &&= (window.cancelAnimationFrame(zt.current), 0)),
      (Bt.current &&= (window.clearTimeout(Bt.current), 0)),
      It.current?.stop?.(),
      (It.current = null),
      (Lt.current = null));
    let e = Rt.current;
    (e && (e.getTracks().forEach((e) => e.stop()), (Rt.current = null)),
      Ft.current && (Ft.current.pause?.(), (Ft.current.srcObject = null)));
  }
  async function kn(e) {
    ...
    let t = window.BarcodeDetector,
      ...
      r =
        typeof t.getSupportedFormats == `function`
          ? await t.getSupportedFormats().catch(() => [])
          : [],
      i = r.length > 0 ? n.filter((e) => r.includes(e)) : n,
      a = new t({ formats: i.length > 0 ? i : n }),
      o = async () => {
        if (!(!Ft.current || !Ie)) {
          if (e.readyState >= 2)
            try {
              let t = await a.detect(e),
                n = String(t?.[0]?.rawValue || ``).trim();
              if (n && n !== Vt.current) {
                ((Vt.current = n), Fn(n));
                return;
              }
          ...
          Bt.current = window.setTimeout(() => {
            zt.current = window.requestAnimationFrame(o);
          }, 120);
        }
      };
    return ((zt.current = window.requestAnimationFrame(o)), !0);
  }
  async function An(e) {
    let { BrowserMultiFormatReader: t } = await Re(async () => {
        let { BrowserMultiFormatReader: e } = await import(`./esm-CvRXmzMK.js`);
        return { BrowserMultiFormatReader: e };
      }, []),
      n = new t();
    return (
      (Lt.current = n),
      (It.current = await n.decodeFromVideoElement(e, (e) => {
        let t = String(e?.getText?.() || e?.text || ``).trim();
        !t || t === Vt.current || ((Vt.current = t), Fn(t));
      })),
      !0
    );
  }
    ...
    if (Ft.current)
      try {
        if (
          ...
          throw Error(`Trinh duyet nay khong ho tro camera barcode.`);
        ...
        let t = String(e?.name || ``);
        throw (
          (t === `NotAllowedError` || t === `SecurityError`) && at(`denied`),
          e
        );
      }
  }
  function Mn() {
    (On(), Le(!1), tt(!1), rt(``), (Vt.current = ``));
  }
  function Nn() {
    if (it === `unsupported`) {
      M(k(`error`, `Thiet bi/trinh duyet nay khong ho tro camera barcode.`));
      return;
    }
    if (it === `denied`) {
      M(
        k(
          `error`,
          `Camera dang bi chan. Hay cap quyen camera trong trinh duyet.`,
        ),
      );
      return;
    }
  ...
  function Pn(e, t = `scan`) {
    let n = We(e);
    if (!n)
      return (
        M(k(`error`, `Vui long nhap barcode hoac SKU truoc khi quet.`)),
        !1
      );
    (te(String(e || ``).trim()), w(String(e || ``).trim()));
    let r = dn.get(n);
    if (!r)
      return (
        M(
          k(
            `error`,
            `Khong tim thay san pham cho ma ${String(e || ``).trim()}.`,
          ),
        ),
        !1
      );
    ...
    return (
      Ee((e) => {
        let t = e.findIndex(
          (e) => We(e?.barcode || e?.productId || e?.sku) === n,
        );
        return t >= 0
          ? e.map((e, n) =>
              n === t
                ? {
                    ...e,
                    barcode: r.barcode || r.productId || r.sku,
                    productId: r.productId || r.barcode || r.sku,
                    sku: r.sku || r.barcode || r.productId,
                    name: r.name || e.name || ``,
                    lineKey: r.lineKey || e.lineKey,
                    locId: r.locId || e.locId,
                    stockStatus: r.stockStatus || e.stockStatus || `unchecked`,
                    lastScannedAt: i,
                    lossQuantity: Ye(e.systemStock, e.actualStock),
                  }
                : e,
            )
          : [
              {
                ...
                actualStock: ``,
                lossQuantity: 0,
                stockStatus: r.stockStatus || `unchecked`,
                scannedAt: i,
                lastScannedAt: i,
              },
              ...e,
      ...
      M(
        k(
          `success`,
          `Da ${t} ${r.name || r.sku || r.barcode || `san pham`} thanh cong.`,
        ),
      ),
      !0
    );
  ...
  function In(e) {
    (e.preventDefault(), Pn(ee, `them`) && te(``));
  }
  function Ln(e, t, n) {
    let r = qe(n);
    Ee((n) =>
      n.map((n) =>
        n.id === e
          ? {
              ...
              [t]: r,
              lossQuantity: Ye(
                t === `systemStock` ? r : n?.systemStock,
                t === `actualStock` ? r : n?.actualStock,
              ),
            }
          : n,
      ),
  ...
  function Rn(e) {
    Ee((t) => t.filter((t) => t.id !== e));
  }
  function zn() {
    (Ee([]), te(``), D(Ge()), Mn());
  }
  async function Bn(e = null) {
    let t = e?.items || Ce;
    if (!Array.isArray(t) || t.length === 0) {
      M(k(`error`, `Khong co du lieu de xuat Excel.`));
      return;
    }
    let n = e?.periodName || T || Ge(),
      r = Ke(n) || `loss`,
      i = e?.createdAt || new Date().toISOString(),
      a = `loss-${r}-${i.slice(0, 10)}.xlsx`,
      o = t.reduce(
        (e, t) => {
          let n = Ze(t);
          return {
            totalSystemStock: e.totalSystemStock + n.systemStock,
            totalActualStock: e.totalActualStock + n.actualStock,
            totalLoss: e.totalLoss + n.lossQuantity,
          };
        },
        { totalSystemStock: 0, totalActualStock: 0, totalLoss: 0 },
      ),
      s = [
        { field: `Ky kiem`, value: n },
        {
          field: `Nguoi tao`,
          value: e?.createdByName || lt?.displayName || lt?.username || `Guest`,
        },
        { field: `Thoi gian`, value: i },
        { field: `Tong SKU`, value: t.length },
        { field: `Tong stock he thong`, value: o.totalSystemStock },
        { field: `Tong stock thuc te`, value: o.totalActualStock },
        { field: `Tổng loss`, value: o.totalLoss },
      ],
      c = t.map((e, t) => {
        let n = ke(e?.stockStatus),
          r = Ze(e);
        return {
          stt: t + 1,
          barcode: e?.barcode || ``,
          ...
          quantityLoss: r.lossQuantity,
          linkedStockStatus: n.label,
        };
      });
    Fe(!0);
    try {
      let e = await Re(() => import(`./xlsx-BrBceiPC.js`), []),
        t = e.utils.book_new(),
        n = e.utils.json_to_sheet(s),
        r = e.utils.json_to_sheet(c);
      (e.utils.book_append_sheet(t, n, He),
        e.utils.book_append_sheet(t, r, Ve),
        e.writeFile(t, a),
        M(k(`success`, `Da xuat file ${a}.`)));
    } catch (e) {
      M(k(`error`, e.message || `Khong the xuat file Excel.`));
    } finally {
      Fe(!1);
    }
  }
  async function Vn() {
    if (Zt) {
      (N(!0),
        M(k(`error`, `Vui long dang nhap de luu ky kiem loss dung chung.`)));
      return;
    }
    if (Ce.length === 0) {
      M(k(`error`, `Kỳ kiểm loss dang rong. Hay quet barcode truoc khi luu.`));
      return;
    }
    let t = T.trim() || Ge(),
      r = new Date().toISOString(),
      a = Ce.map((e) => {
        let t = dn.get(We(e?.barcode || e?.productId || e?.sku)),
          n = Ze(e);
        return {
          barcode: e?.barcode || ``,
          productId: e?.productId || ``,
          ...
          lineKey: e?.lineKey || ``,
          locId: e?.locId || ``,
          systemStock: n.systemStock,
          actualStock: n.actualStock,
          lossQuantity: n.lossQuantity,
          stockStatus: ke(t?.stockStatus || e?.stockStatus).id,
          scannedAt: e?.scannedAt || r,
          lastScannedAt: e?.lastScannedAt || r,
        };
      }),
      o = {
        ...
        periodName: t,
        createdAt: r,
        createdByName: lt?.displayName || lt?.username || `Unknown`,
        createdByUsername: lt?.username || ``,
        itemCount: a.length,
        totalSystemStock: a.reduce((e, t) => e + Je(t?.systemStock), 0),
        totalActualStock: a.reduce((e, t) => e + Je(t?.actualStock), 0),
        totalLossQuantity: a.reduce((e, t) => e + Je(t?.lossQuantity), 0),
        items: a,
      },
      s = [o, ...i].slice(0, 200);
    je(!0);
    try {
      (await bn(e, n, s),
        ...
        M(
          k(
            `success`,
            `Da luu ky ${t}: ${o.itemCount} SKU, tong loss ${o.totalLossQuantity}.`,
          ),
        ));
    } catch (e) {
      M(k(`error`, e.message || `Khong luu duoc ky kiem loss.`));
    } finally {
      je(!1);
    }
  }
  function Hn(e, t) {
    let n = g ? g.split(`-`)[0] === e.id : !1;
    return (0, A.jsxs)(
      `article`,
      {
        className: [
          `aisle-card`,
          t === `secondary` ? `aisle-card-muted` : ``,
          n ? `aisle-card-selected` : ``,
        ]
          .filter(Boolean)
          .join(` `),
        children: [
          (0, A.jsx)(`header`, {
            className: `aisle-card-header`,
            children: e.id,
          }),
          (0, A.jsx)(`div`, {
            className: `aisle-card-sides`,
            children: [`A`, `B`].map((t) =>
              (0, A.jsx)(
                `button`,
                {
                  type: `button`,
                  className: `aisle-side-button ${g === `${e.id}-${t}` ? `is-active` : ``}`,
                  onClick: () => hn(e.id, t),
                  children: t,
                },
                `${e.id}-${t}`,
  ...
  let Un = F?.data.products.length || 0,
    Wn = f === `pog` ? `POG workspace` : `Check Loss workspace`,
    Gn =
      f === `pog`
        ? [
            { label: `Line co du lieu`, value: ln },
            { label: `Tong SKU`, value: un },
            { label: `Dang mo`, value: F ? `${F.id}-${F.side}` : `Chua chon` },
            ...(Jt
              ? [{ label: `Ket qua tim`, value: rn.length, highlight: !0 }]
              : []),
          ]
        : [
            { label: `Ky da luu`, value: i.length },
            { label: `SKU dang quet`, value: mn.totalItems },
            { label: `Stock he thong`, value: mn.totalSystemStock },
            { label: `Tổng loss`, value: mn.totalLoss, highlight: !0 },
          ],
    Kn = F
      ? (0, A.jsxs)(`aside`, {
          className: `drawer ${c ? `drawer-mobile` : ``}`,
          children: [
            (0, A.jsxs)(`div`, {
              className: `drawer-header ${F.cat === `HBC` ? `drawer-header-hbc` : ``}`,
              children: [
                (0, A.jsxs)(`div`, {
                  children: [
                    (0, A.jsxs)(`p`, {
                      className: `drawer-overline`,
                      children: [`Line `, F.id, ` | Side `, F.side],
                    }),
                    (0, A.jsxs)(`h2`, {
                      children: [
                        (0, A.jsx)(ve, { size: 18 }),
                        (0, A.jsx)(`span`, { children: F.name }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, A.jsxs)(`div`, {
              ...
              children: [
                  ...
                  children: [
                    o
                      ? (0, A.jsxs)(`div`, {
                          ...
                          children: [
                            (0, A.jsx)(`span`, {
                              className: `shared-loading-dot`,
                            }),
                            (0, A.jsx)(`p`, {
                              children: `Dang dong bo du lieu line tu may chu...`,
                            }),
                          ],
                        })
                      : null,
                    c
                      ? (0, A.jsxs)(`div`, {
                          ...
                          children: [
                            (0, A.jsxs)(`span`, {
                              className: `mobile-selected-pill`,
                              children: [Un, ` san pham`],
                            }),
                            (0, A.jsx)(`span`, {
                              className: `mobile-selected-pill`,
                              children: F.cat,
                      ...
                      : null,
                    (0, A.jsx)($e, {
                      visual: F.data.visual,
                      highlightedLọcIds: sn,
                      enableMagnifier: !c,
                    }),
                    (0, A.jsxs)(`section`, {
                      ...
                      children: [
                        ...
                        (0, A.jsx)(`div`, {
                          className: `stock-summary-inline`,
                          children: ze.map((e) =>
                            (0, A.jsxs)(
                              `span`,
                              {
                                className: `stock-summary-pill stock-summary-pill-${e.tone}`,
                                children: [
                                  (0, A.jsx)(`span`, {
                                    children: e.shortLabel,
                                  }),
                                  (0, A.jsx)(`strong`, { children: cn[e.id] }),
                                ],
                              },
                              e.id,
                            ),
                ...
                (0, A.jsx)(`div`, {
                  className: `drawer-products-scroll`,
                  children:
                    on.length > 0
                      ? (0, A.jsx)(`div`, {
                          className: `product-list`,
                          children: on.map((e, t) => {
                            let n = Jt && Ue(e).includes(Jt),
                              r = j(b) === j(e.locId),
                              i = ke(e.stockStatus),
                              a = F.data.products.findIndex((t) => t === e),
                              o =
                                vt === `${g}-${e.locId}-${e.sku || `na`}-${a}`;
                            return (0, A.jsxs)(
                              `article`,
                              {
                                className: `product-card ${n ? `product-card-match` : ``} ${r ? `product-card-focused` : ``}`,
                                onMouseEnter: () => x(e.locId),
                                onMouseLeave: () => x(null),
                                onFocus: () => x(e.locId),
                                onBlur: () => x(null),
                                onClick: () => x(e.locId),
                                ...
                                children: [
                                  (0, A.jsxs)(`div`, {
                                    className: `product-topline`,
                                    children: [
                                      (0, A.jsxs)(`div`, {
                                        className: `product-meta`,
                                        children: [
                                          (0, A.jsxs)(`span`, {
                                            className: `product-badge ${n ? `product-badge-match` : ``}`,
                                            children: [`Nhan `, e.locId],
                                          }),
                                          e.sku
                                            ? (0, A.jsx)(`span`, {
                                      ...
                                      (0, A.jsx)(`select`, {
                                        className: `stock-select stock-select-${i.tone}`,
                                        value: i.id,
                                        disabled: o,
                                  ...
                                  (0, A.jsxs)(`div`, {
                                    ...
                                    children: [
                                      e.verified
                                        ...
                                        : (0, A.jsx)(`span`, {
                                            className: `stock-timestamp stock-timestamp-empty`,
                                            children: `Chưa đối chiếu`,
                                          }),
                                      e.stockCheckedAt
                                        ? (0, A.jsxs)(`p`, {
                                            className: `stock-timestamp`,
                                            children: [
                                              `Cap nhat: `,
                                              Ne(e.stockCheckedAt),
                                            ],
                                        ...
                                        : (0, A.jsx)(`p`, {
                                            className: `stock-timestamp stock-timestamp-empty`,
                                            children: `Chưa kiểm tra tồn kho`,
                                          }),
                                    ],
                                  }),
                                ],
                      ...
                      : (0, A.jsxs)(`div`, {
                          ...
                          children: [
                            (0, A.jsx)(se, { size: 42, strokeWidth: 1.4 }),
                            (0, A.jsx)(`p`, {
                              children: `Line nay chua co du lieu hang hoa`,
                            }),
                            Zt
                              ? (0, A.jsx)(`button`, {
                                  type: `button`,
                                  ...
                                  onClick: () => N(!0),
                                  children: `Đăng nhập để cập nhật POG`,
                                })
                              : (0, A.jsx)(`button`, {
                                  type: `button`,
                                  className: `inline-link`,
                                  onClick: _n,
                                  children: `Dong bo tu PDF ngay`,
                                }),
                          ],
                        }),
                }),
      ...
      : null,
    qn = (0, A.jsxs)(`section`, {
      className: `loss-layout`,
      children: [
        (0, A.jsxs)(`section`, {
          className: `loss-toolbar-card`,
          children: [
            (0, A.jsxs)(`div`, {
              className: `loss-toolbar-copy`,
              children: [
                (0, A.jsx)(`p`, {
                  className: `section-label`,
                  children: `Kiểm loss sản phẩm`,
                }),
                (0, A.jsxs)(`h2`, {
                  children: [
                    (0, A.jsx)(O, { size: 18 }),
                    (0, A.jsx)(`span`, {
                      children: `Quét barcode, đối chiếu stock và lưu kỳ kiểm`,
                    }),
                  ],
                }),
                (0, A.jsx)(`p`, {
                  children: `Giao diện ưu tiên quét nhanh, nhập nhanh và xem lịch sử ở cùng một màn hình.`,
                }),
              ],
            }),
            (0, A.jsx)(`div`, {
              className: `summary-strip summary-strip-inline`,
              "aria-label": `Tổng quan check loss`,
              children: Gn.map((e) =>
                (0, A.jsxs)(
                  `article`,
                  {
                    className: `summary-card ${e.highlight ? `summary-card-highlight` : ``}`,
                    children: [
                      (0, A.jsx)(`span`, { children: e.label }),
                      (0, A.jsx)(`strong`, { children: e.value }),
                    ],
                  },
                  `loss-summary-${e.label}`,
                ),
              ),
            }),
          ],
        ...
        (0, A.jsxs)(`section`, {
          className: `loss-workspace-grid`,
          children: [
            (0, A.jsxs)(`article`, {
              className: `loss-card loss-entry-card`,
              children: [
                (0, A.jsx)(`div`, {
                  className: `loss-card-head`,
                  children: (0, A.jsxs)(`div`, {
                    children: [
                      (0, A.jsxs)(`h3`, {
                        children: [
                          (0, A.jsx)(ne, { size: 18 }),
                          (0, A.jsx)(`span`, {
                            children: `Phiếu quét hiện tại`,
                          }),
                        ],
                      }),
                      (0, A.jsx)(`p`, {
                        children: `Nhập hoặc quét barcode để thêm sản phẩm, sau đó điền stock hệ thống và stock thực tế.`,
                      }),
                    ],
                  }),
                }),
                (0, A.jsxs)(`form`, {
                  className: `loss-entry-form`,
                  onSubmit: In,
                  children: [
                    (0, A.jsxs)(`label`, {
                      className: `field`,
                      children: [
                        (0, A.jsx)(`span`, { children: `Tên kỳ kiểm` }),
                        (0, A.jsx)(`input`, {
                          type: `text`,
                          value: T,
                          onChange: (e) => D(e.target.value),
                          placeholder: `VD: Kỳ kiểm loss tuan 1`,
                        }),
                      ],
                    }),
                    (0, A.jsxs)(`label`, {
                      ...
                      children: [
                        (0, A.jsx)(`span`, {
                          children: `Barcode / SKU / Product ID`,
                        }),
                        (0, A.jsxs)(`div`, {
                          className: `loss-scan-row`,
                          children: [
                            (0, A.jsx)(`input`, {
                              type: `text`,
                              value: ee,
                            ...
                            (0, A.jsxs)(`button`, {
                              type: `button`,
                              className: `secondary-button loss-scan-button`,
                              onClick: Nn,
                              children: [
                                (0, A.jsx)(re, { size: 16 }),
                                (0, A.jsx)(`span`, { children: `Quét` }),
                              ],
                            }),
                            (0, A.jsxs)(`button`, {
                              type: `submit`,
                ...
                (0, A.jsxs)(`div`, {
                  className: `loss-entry-actions`,
                  children: [
                    (0, A.jsx)(`button`, {
                      type: `button`,
                      className: `secondary-button`,
                      onClick: zn,
                      children: `Làm mới phiếu`,
                    }),
                    (0, A.jsxs)(`button`, {
                      type: `button`,
                      className: `secondary-button`,
                      disabled: Pe || Ce.length === 0,
                      onClick: () => Bn(null),
                      children: [
                        (0, A.jsx)(ce, { size: 15 }),
                        (0, A.jsx)(`span`, {
                    ...
                    (0, A.jsxs)(`button`, {
                      ...
                      disabled: Ae || Ce.length === 0,
                      onClick: Vn,
                      children: [
                        (0, A.jsx)(oe, { size: 16 }),
                        (0, A.jsx)(`span`, {
                          children: Ae ? `Đang lưu...` : `Lưu kỳ loss`,
                        }),
                      ],
                    }),
                  ],
                ...
                Zt
                  ? (0, A.jsx)(`p`, {
                      className: `helper-text loss-readonly-note`,
                      children: `Đang ở chế độ xem. Đăng nhập để lưu kỳ loss dùng chung.`,
                    })
                  : null,
                (0, A.jsx)(`div`, {
                  className: `loss-draft-list`,
                  children:
                    fn.length > 0
                      ? fn.map((e) => {
                          let t = ke(
                              dn.get(We(e?.barcode || e?.productId || e?.sku))
                          ...
                          return (0, A.jsxs)(
                            `article`,
                            {
                              className: `loss-item-row`,
                              children: [
                                (0, A.jsxs)(`div`, {
                                  className: `loss-item-main`,
                                  children: [
                                    (0, A.jsx)(`h4`, {
                                      children: (0, A.jsx)(Qe, {
                                        text: e.name || `Sản phẩm chưa có tên`,
                                        highlight: S,
                                      }),
                                    }),
                                    (0, A.jsxs)(`p`, {
                                ...
                                (0, A.jsxs)(`div`, {
                                  className: `loss-item-controls`,
                                  children: [
                                    (0, A.jsxs)(`span`, {
                                      className: `stock-summary-pill stock-summary-pill-${t.tone}`,
                                      children: [
                                        (0, A.jsx)(`span`, {
                                          children: `Stock`,
                                        }),
                                    ...
                                    (0, A.jsxs)(`div`, {
                                      className: `loss-delta-pill`,
                                      title: `Stock he thong tru stock thuc te`,
                                      children: [
                                        (0, A.jsx)(`span`, {
                                          children: `Loss`,
                                        }),
                                        (0, A.jsx)(`strong`, {
                                          children: n.lossQuantity,
                                        }),
                                      ],
                                    }),
                                    (0, A.jsx)(`button`, {
                      ...
                      : (0, A.jsxs)(`div`, {
                          className: `empty-state loss-empty-state`,
                          children: [
                            (0, A.jsx)(se, { size: 34, strokeWidth: 1.4 }),
                            (0, A.jsx)(`p`, {
                              children: `Phiếu loss đang rỗng. Bắt đầu quét barcode để tạo danh sách.`,
                            }),
                          ],
                        }),
                }),
            ...
            (0, A.jsxs)(`article`, {
              className: `loss-card loss-history-card`,
              children: [
                (0, A.jsx)(`div`, {
                  className: `loss-card-head`,
                  children: (0, A.jsxs)(`div`, {
                    children: [
                      (0, A.jsxs)(`h3`, {
                        children: [
                          (0, A.jsx)(E, { size: 18 }),
                          (0, A.jsx)(`span`, {
                            children: `Lịch sử các kỳ kiểm loss`,
                          }),
                        ],
                      }),
                      (0, A.jsx)(`p`, {
                        children: `Lưu trữ các kỳ trước đó và xuất lại Excel bất cứ lúc nào.`,
                      }),
                    ],
                  }),
                }),
                (0, A.jsx)(`div`, {
                  className: `loss-history-list`,
                  children:
                    pn.length > 0
                      ? pn.map((e) => {
                          let t = new Date(e?.createdAt || ``),
                            n = Number.isNaN(t.getTime())
                              ? `--`
                              : t.toLọcaleString(`vi-VN`);
                          return (0, A.jsxs)(
                            `article`,
                            {
                              className: `loss-history-row`,
                              children: [
                                (0, A.jsxs)(`div`, {
                                  className: `loss-history-main`,
                                  children: [
                                    (0, A.jsx)(`h4`, {
                                      children: e.periodName || `Kỳ kiểm loss`,
                                    }),
                                    (0, A.jsxs)(`p`, {
                                      children: [
                                        n,
                                        ` | `,
                                        e.createdByName || `Không rõ người tạo`,
                                      ],
                                    }),
                                    (0, A.jsxs)(`p`, {
                                      children: [
                            ...
                            e.id || `${e.periodName}-${e.createdAt}`,
                          );
                        })
                      : (0, A.jsxs)(`div`, {
                          className: `empty-state loss-empty-state`,
                          children: [
                            (0, A.jsx)(E, { size: 34, strokeWidth: 1.4 }),
                            (0, A.jsx)(`p`, {
                              children: `Chưa có kỳ kiểm loss nào được lưu.`,
                            }),
                          ],
                        }),
                }),
      ...
      children: c
            ...
            children: [
                ...
                children: [
                  (0, A.jsxs)(`div`, {
                    children: [
                      (0, A.jsx)(`div`, {
                        className: `section-label`,
                        children: `Bản đồ line`,
                      }),
                      (0, A.jsx)(`p`, {
                        className: `map-help-text`,
                        children: `Chọn nhóm line, sau đó chạm vào mặt kệ A/B để xem chi tiết.`,
                      }),
                    ],
                  }),
                  F
              ...
              (0, A.jsxs)(`div`, {
                ...
                children: [
                  (0, A.jsx)(`button`, {
                    type: `button`,
                    className: m === `main` ? `is-active` : ``,
                    onClick: () => h(`main`),
                    children: `Line chính`,
                  }),
                  (0, A.jsx)(`button`, {
                    type: `button`,
                    className: m === `secondary` ? `is-active` : ``,
                    onClick: () => h(`secondary`),
                    children: `Line phụ`,
                  }),
                ],
              ...
              (0, A.jsx)(`div`, {
                className: `aisle-grid aisle-grid-mobile`,
                children: (m === `secondary` ? Te : we).map((e) =>
                  Hn(e, m === `secondary` ? `secondary` : `primary`),
                ),
              }),
            ],
          })
        : (0, A.jsxs)(A.Fragment, {
            children: [
              (0, A.jsx)(`div`, {
                className: `section-label`,
                children: `Bản đồ line phụ`,
              }),
              (0, A.jsx)(`div`, {
                className: `aisle-grid`,
                children: Te.map((e) => Hn(e, `secondary`)),
              }),
              (0, A.jsx)(`div`, {
                className: `walkway`,
                children: `Lối đi chính | Picker Path`,
              }),
              (0, A.jsx)(`div`, {
                className: `section-label`,
                children: `Bản đồ line chính`,
              }),
              (0, A.jsx)(`div`, {
                className: `aisle-grid`,
                children: we.map((e) => Hn(e, `primary`)),
              }),
            ],
          }),
    }),
    Yn = !c && u && !!F,
    Xn = `workspace ${F ? `has-drawer` : `no-drawer`} ${c ? `is-compact` : `is-desktop`} ${Yn ? `has-desktop-resizer` : ``} ${Gt ? `is-resizing` : ``}`,
    Zn = Yn ? { "--drawer-width": `${Ut}px` } : void 0;
  return (0, A.jsxs)(`div`, {
    className: `app-shell`,
    children: [
      ot
        ? (0, A.jsxs)(`div`, {
            className: `toast toast-${ot.type}`,
            role: `status`,
            "aria-live": `polite`,
            children: [
              (0, A.jsxs)(`div`, {
                ...
                children: [
                  ot.type === `success`
                    ? (0, A.jsx)(ae, { size: 20 })
                    : (0, A.jsx)(be, { size: 20 }),
                  (0, A.jsx)(`span`, { children: `Thông báo hệ thống` }),
                ],
              }),
              (0, A.jsx)(`p`, { children: ot.message }),
            ],
          })
        : null,
      (0, A.jsx)(`header`, {
        ...
        children: (0, A.jsxs)(`div`, {
          ...
          children: [
            (0, A.jsxs)(`div`, {
              ...
              children: [
                (0, A.jsx)(`div`, {
                  ...
                  children: (0, A.jsx)(me, { size: 22 }),
                }),
                (0, A.jsxs)(`div`, {
                  children: [
                    (0, A.jsx)(`p`, {
                      className: `brand-title`,
                      children: `Picker Assistant`,
                    }),
                    (0, A.jsx)(`p`, {
            ...
            (0, A.jsxs)(`div`, {
              ...
              children: [
                (0, A.jsxs)(`div`, {
                  className: `topbar-console-row topbar-console-row-meta`,
                  children: [
                    (0, A.jsxs)(`div`, {
                      className: `topbar-module-switch`,
                      role: `tablist`,
                      "aria-label": `Chọn module`,
                      children: [
                        (0, A.jsx)(`button`, {
                          type: `button`,
                          className: f === `pog` ? `is-active` : ``,
                          onClick: () => p(`pog`),
                          children: `POG`,
                        }),
                        (0, A.jsx)(`button`, {
                          type: `button`,
                          className: f === `loss` ? `is-active` : ``,
                          onClick: () => p(`loss`),
                          children: `Check Loss`,
                        }),
                      ],
                    ...
                    (0, A.jsxs)(`span`, {
                      ...
                      children: [
                        (0, A.jsx)(xe, { size: 14 }),
                        (0, A.jsx)(`span`, { children: Xt }),
                      ],
                    }),
                  ],
                }),
                (0, A.jsxs)(`div`, {
                  className: `topbar-console-row topbar-console-row-actions`,
                  children: [
                    (0, A.jsxs)(`label`, {
                      className: `searchbox`,
                      children: [
                      ...
                      children: [
                        ...
                        Zt
                          ? (0, A.jsxs)(`button`, {
                              ...
                              children: [
                                (0, A.jsx)(fe, { size: 15 }),
                                (0, A.jsx)(`span`, { children: `Đăng nhập` }),
                              ],
                            })
                          : (0, A.jsxs)(`button`, {
                              type: `button`,
                              ...
                              children: [
                                (0, A.jsx)(pe, { size: 15 }),
                                (0, A.jsx)(`span`, { children: `Đăng xuất` }),
                              ],
                            }),
                      ],
                    }),
      ...
      f === `pog`
        ? (0, A.jsxs)(A.Fragment, {
            children: [
              (0, A.jsx)(`main`, {
                ...
                style: Zn,
                children: c
                  ? (0, A.jsxs)(A.Fragment, { children: [Kn, Jn] })
                  : Yn
                    ? (0, A.jsxs)(A.Fragment, {
                        children: [
                          Jn,
                    ...
                    : (0, A.jsxs)(A.Fragment, { children: [Jn, Kn] }),
              }),
              c
                ? (0, A.jsxs)(`section`, {
                    className: `mobile-action-dock`,
                    "aria-label": `Tac vu nhanh`,
                    children: [
                      (0, A.jsxs)(`button`, {
                        type: `button`,
                        ...
                        children: [
                          (0, A.jsx)(ge, { size: 16 }),
                          (0, A.jsx)(`span`, { children: `Cập nhật POG` }),
                        ],
                      }),
                      Zt
                        ? (0, A.jsxs)(`button`, {
        ...
        : (0, A.jsx)(`main`, {
            className: `workspace workspace-loss`,
            children: qn,
          }),
      dt
        ? (0, A.jsx)(`div`, {
            ...
            children: (0, A.jsxs)(`section`, {
              className: `auth-card auth-form auth-modal-card login-modal`,
              children: [
                (0, A.jsxs)(`div`, {
                ...
                (0, A.jsxs)(`div`, {
                  ...
                  children: [
                    (0, A.jsx)(`h1`, { children: `Đăng nhập tài khoản` }),
                    (0, A.jsx)(`p`, {
                      children: `Vui lòng đăng nhập để cập nhật POG và chỉnh sửa tồn kho.`,
                    }),
                  ],
                }),
                (0, A.jsxs)(`div`, {
                  ...
                  children: [
                    (0, A.jsx)(`strong`, {
                      children: `Không cần đăng nhập để xem dữ liệu`,
                    }),
                    (0, A.jsx)(`span`, {
                      children: `Bạn vẫn có thể xem line và tìm kiếm sản phẩm. Đăng nhập để cập nhật dữ liệu dùng chung.`,
                    }),
                  ],
                }),
                (0, A.jsxs)(`form`, {
                  ...
                  children: [
                    (0, A.jsxs)(`label`, {
                      ...
                      children: [
                        (0, A.jsxs)(`span`, {
                          children: [(0, A.jsx)(xe, { size: 14 }), `Tài khoản`],
                        }),
                        (0, A.jsx)(`input`, {
                          type: `text`,
                          value: mt,
                    ...
                    (0, A.jsxs)(`label`, {
                      ...
                      children: [
                        (0, A.jsxs)(`span`, {
                          children: [(0, A.jsx)(fe, { size: 14 }), `Mật khẩu`],
                        }),
                        (0, A.jsx)(`input`, {
                          type: `password`,
                          value: gt,
                        ...
                        (0, A.jsxs)(`button`, {
                          ...
                          children: [
                            ft
                              ...
                              : (0, A.jsx)(fe, { size: 16 }),
                            (0, A.jsx)(`span`, {
                              children: ft ? `Đang xử lý...` : `Đăng nhập`,
                            }),
                          ],
                        }),
                      ],
        ...
        ? (0, A.jsx)(`div`, {
            ...
            children: (0, A.jsxs)(`section`, {
              ...
              children: [
                  ...
                  children: [
                    (0, A.jsxs)(`div`, {
                      ...
                      children: [
                        (0, A.jsx)(re, { size: 28 }),
                        (0, A.jsx)(`span`, {
                          children: `Quét barcode bang camera`,
                        }),
                      ],
                    }),
                    (0, A.jsx)(`button`, {
                ...
                (0, A.jsxs)(`div`, {
                  className: `modal-body scanner-modal-body`,
                  children: [
                    (0, A.jsxs)(`div`, {
                    ...
                    (0, A.jsxs)(`div`, {
                      ...
                      children: [
                        (0, A.jsx)(`strong`, {
                          children: `Huong camera vao barcode cua san pham`,
                        }),
                        (0, A.jsx)(`p`, {
                          children: `App se tu dong nhan barcode, doi chieu voi du lieu POG va them vao phieu loss.`,
                        }),
                      ],
                    }),
                    et
                      ? (0, A.jsxs)(`div`, {
                          className: `shared-loading scanner-loading`,
                          children: [
                            (0, A.jsx)(`span`, {
                              className: `shared-loading-dot`,
                            }),
                            (0, A.jsx)(`p`, {
                              children: `Dang khoi dong camera...`,
                            }),
                          ],
                        })
                      : null,
                  ...
                  children: [
                    (0, A.jsxs)(`div`, {
                      ...
                      children: [
                        (0, A.jsx)(_e, { size: 30 }),
                        (0, A.jsx)(`span`, {
                          children: `Cập nhật POG va hinh line`,
                        }),
                      ],
                    }),
                    (0, A.jsx)(`button`, {
                            ...
                            (0, A.jsxs)(`label`, {
                              ...
                              children: [
                                ...
                                (0, A.jsx)(`strong`, {
                                  children: Nt
                                    ? Nt.name
                                    : `Tai len PDF planogram`,
                                }),
                                (0, A.jsx)(`span`, {
                                  children: `App se doc text, tim hinh line, va map cac vi tri locId ngay tren may`,
                                }),
                              ],
                            }),
                            (0, A.jsxs)(`div`, {
                              ...
                              children: [
                                (0, A.jsxs)(`button`, {
                                  ...
                                  children: [
                                    (0, A.jsx)(ge, { size: 18 }),
                                    (0, A.jsx)(`span`, {
                                      children: `Phan tich tep tin`,
                                    }),
                                  ],
                                }),
                                (0, A.jsx)(`p`, {
                                  className: `helper-text`,
                                  children: `Phan tich cuc bo tren may. Neu PDF co trang line va nhan locId, app se khoanh vi tri san pham tren hinh.`,
                                }),
                              ],
                            }),
                          ],
                      ...
                      ? (0, A.jsxs)(`div`, {
                          ...
                          children: [
                            (0, A.jsx)(`div`, {
                              ...
                              children: (0, A.jsx)(ve, { size: 38 }),
                            }),
                            (0, A.jsxs)(`div`, {
                              children: [
                                (0, A.jsx)(`h3`, {
                                  children: `Dang phan tich PDF...`,
                                }),
                                (0, A.jsx)(`p`, {
                                  children: `App dang tach bang SKU va tim trang hinh line de map vi tri san pham.`,
                                }),
                              ],
                            }),
                          ],
                            ...
                            (0, A.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, A.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, A.jsxs)(`div`, {
                                      className: `extract-column-head`,
                                      children: [
                                        (0, A.jsx)(`strong`, {
                                          children: `Danh sách sản phẩm trich xuat`,
                                        }),
                                        (0, A.jsxs)(`span`, {
                                          children: [kt.length, ` SKU`],
                                        }),
                                      ],
                                    }),
                                    (0, A.jsx)(`div`, {
                                        ...
                                        (0, A.jsxs)(
                                          `article`,
                                          {
                                            ...
                                            children: [
                                              ...
                                              (0, A.jsx)(`span`, {
                                                className: `extract-sku`,
                                                children: String(e.sku),
                                              }),
                                            ],
                                          },
                                          `${e.locId}-${e.sku}-${t}`,
                            ...
                            (0, A.jsxs)(`div`, {
                              ...
                              children: [
                                (0, A.jsx)(`button`, {
                                  ...
                                  className: `secondary-button`,
                                  onClick: () => Ct(1),
                                  children: `Quét lai file`,
                                }),
                                (0, A.jsx)(`button`, {
                                  type: `button`,
                                  className: `success-button`,
                                  onClick: Tn,
                                  children: `Xac nhan dong bo`,
                                }),
                              ],
                            }),
                          ],
...
Ce.createRoot(document.getElementById(`root`)).render(
  (0, A.jsx)(C.StrictMode, { children: (0, A.jsx)(et, {}) }),
);
export { Re as t };
